...
module SmartAnswer::Calculators
  class StatePensionTopUpCalculatorTest < ActiveSupport::TestCase
    ...
    context "test available years functions" do
      ...
      #     @calculator = SmartAnswer::Calculators::StatePensionTopUpCalculator.new(gender: "male", dob: dob, qualifying_years: nil)
      #   end
    ...
    context "state_pension_age tests" do
      ...
      context "tests for state_pension_date dynamic dates" do
        should "male/female born 1950 Apr 06" do
          @calc_male = SmartAnswer::Calculators::StatePensionTopUpCalculator.new(
              gender: "male", dob: "1950 Apr 06", qualifying_years: nil)
          @calc_female = SmartAnswer::Calculators::StatePensionTopUpCalculator.new(
